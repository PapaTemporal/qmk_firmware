...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_ortho_12x4(
        ...
        KC_NO,          KC_NO,        KC_NO,        KC_NO,          KC_SPACE,       KC_EQUAL,        KC_TRANSPARENT,  KC_NO,    KC_NO,    KC_NO,   KC_NO,    KC_NO
    ),
    /*
     * NAVIGATION & FUNCTION KEYS
     * ┌──────┬─────┬────┬────┬─────┬──────┐  ┌───┬──────┬────┬──────┬───┬────┐
     * │ BOOT │ F10 │ F9 │ F8 │ F7  │ CUST │  │   │ HOME │ UP │ END  │   │ L0 │
     * ├──────┼─────┼────┼────┼─────┼──────┤  ├───┼──────┼────┼──────┼───┼────┤
     * │      │ F11 │ F6 │ F5 │ F4  │ CUST │  │   │ LEFT │ DN │ RGT  │   │ L1 │
     * ├──────┼─────┼────┼────┼─────┼──────┤  ├───┼──────┼────┼──────┼───┼────┤
     * │      │ F12 │ F3 │ F2 │ F1  │ CUST │  │   │ PGUP │ ,  │ PGDN │   │ L4 │
     * ├──────┼─────┼────┼────┼─────┼──────┤  ├───┼──────┼────┼──────┼───┼────┤
     * │      │     │    │    │ CTL │ SFT  │  │   │      │    │      │   │    │
     * └──────┴─────┴────┴────┴─────┴──────┘  └───┴──────┴────┴──────┴───┴────┘
     */
    [3] = LAYOUT_ortho_12x4(
        QK_BOOT,  KC_F10,   KC_F9,   KC_F8,   KC_F7,      CUST1,           KC_NO,    KC_HOME,        KC_UP,      KC_END,   KC_NO,   TO(0),
        KC_NO,    KC_F11,   KC_F6,   KC_F5,   KC_F4,      CUST2,           KC_NO,    KC_LEFT,        KC_DOWN,    KC_RIGHT, KC_NO,   TO(1),
        KC_NO,    KC_F12,   KC_F3,   KC_F2,   KC_F1,      CUST3,           KC_NO,    KC_PGUP,        KC_NO,      KC_PGDN,  KC_NO,   TO(4),
     ...
     * ┌─────┬─────┬───┬───┬─────┬───┐  ┌─────┬─────┬───┬───┬───┬────┐
     * │ ESC │  M  │ Q │ W │  E  │ R │  │ F1  │  ?  │ ? │ ? │   │ L0 │ M here is for mute toggle
     * ├─────┼─────┼───┼───┼─────┼───┤  ├─────┼─────┼───┼───┼───┼────┤
     * │ TAB │ SFT │ A │ S │  D  │ F │  │ F4  │  ?  │ ? │ ? │   │ L1 │
     * ├─────┼─────┼───┼───┼─────┼───┤  ├─────┼─────┼───┼───┼───┼────┤
     * │ ALT │ CTL │ Z │ X │  C  │ V │  │  ?  │  ?  │ ? │ ? │ ? │    │
     * ├─────┼─────┼───┼───┼─────┼───┤  ├─────┼─────┼───┼───┼───┼────┤
     * │     │     │   │   │ SPC │   │  │ BSP │ ENT │   │   │   │    │
     ...
     */
    [4] = LAYOUT_ortho_12x4(
        KC_ESC,        KC_M,      KC_Q,   KC_W,   KC_E,     KC_R,      KC_F1,          KC_TRANSPARENT,     KC_TRANSPARENT,     KC_TRANSPARENT,   KC_NO,            TO(0),
        KC_TAB,        KC_LSFT,   KC_A,   KC_S,   KC_D,     KC_F,      KC_F4,          KC_TRANSPARENT,     KC_TRANSPARENT,     KC_TRANSPARENT,   KC_NO,            TO(1),
    ...
    switch (keycode) {
        case CUST1:
            if (record->event.pressed) {
                SEND_STRING("<something custom>");
            }
            return false;
        case CUST2:
            if (record->event.pressed) {
                SEND_STRING("<something else custom>");
            }
            return false;
        case CUST3:
            if (record->event.pressed) {
                SEND_STRING("<and yet again>");
            }
            return false;
    }
